...
SOURCES = \
	__init__.py \
	nys_geocoder.py nys_geocoder_dialog.py

PLUGINNAME = nys_geocoder

PY_FILES = \
	__init__.py \
	nys_geocoder.py nys_geocoder_dialog.py

UI_FILES = nys_geocoder_dialog_base.ui
...
QGISDIR=C:\Users\kgj2\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
